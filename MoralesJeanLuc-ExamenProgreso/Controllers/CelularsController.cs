...
namespace MoralesJeanLuc_ExamenProgreso.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(MoralesJeanLuc_ExamenProgresoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Año,Precio,IdMoralesJeanLuc")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Año,Precio,IdMoralesJeanLuc")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
